...
<head>
  ...
  <title>Update Tattoo| TattOO Management System</title>
   ...
   <?php include_once('includes/sidebar.php');?>
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-file-text-o"></i>Update Tattoo Detail</h3>
            <ol class="breadcrumb">
...
?>
                  <div class="form-group">
                    <label class="col-sm-2 control-label">Tattoo Type</label>
                    <div class="col-sm-10">
