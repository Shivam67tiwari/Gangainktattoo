...
<head>
  ...
  <title>Manage Tattoo Type| Tattoo Management System</title>
        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
              ...
              <li><i class="fa fa-table"></i>Manage Tattoo Type</li>
              <li><i class="fa fa-th-list"></i>Manage Tattoo Type</li>
            </ol>
          </div>
        </div>
        <!-- page start-->
