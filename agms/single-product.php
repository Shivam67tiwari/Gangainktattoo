...
<html lang="zxx">
   <head>
      <title>TAITOO Management System | Single Product</title>
            ...
            <?php endif;?>
                  ...
                  <div class="col-lg-8 single-right-left simpleCart_shelfItem">
                     ...
                     <div class="occasional">
                        <h5>TAITOO Types : <?php echo $row['typename'];?></h5>
                       
                       <h5>TAITOO Medium : <?php echo $row['amname'];?></h5>
                       <h5>TAITOO Reference Number : <?php echo $row['RefNum'];?></h5>
