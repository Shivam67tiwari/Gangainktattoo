...
<head>
  ...
  <title>Manage Tattoo Medium| Tattoo Management System</title>
  ...
  <section id="container" class="">
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-table"></i> Manage Tattoo Medium</h3>
            <ol class="breadcrumb">
              <li><i class="fa fa-home"></i><a href="dashboard.php">Home</a></li>
              <li><i class="fa fa-table"></i>Manage Tattoo Medium</li>
              <li><i class="fa fa-th-list"></i>Manage Tattoo Medium</li>
            </ol>
          </div>
        </div>
        <!-- page start-->
